...
<head>
    <meta charset="UTF-8">
    <title>ReviewSystem数据管理系统</title>
...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-header">
        <!--系统标题-->
        <div class="layui-logo" style="font-size:18px">ReviewSystem管理系统</div>
        <!--右侧当前用户信息-->
            ...
            <ul class="layui-nav layui-nav-tree">
                    ...
                    <li class="layui-nav-item layui-nav-itemed">
                        ...
                        <dl class="layui-nav-child module" data-node-id="xxx">
                            ...
                            <dd><a href="/management/evaluation/comment.html" target="ifmMain">短评管理
                                </a></dd>
                        </dl>
                    </li>
    ...
    <div class="layui-footer">
        Copyright © ReviewSystem. All Rights Reserved.
    </div>
</div>
<!--LayUI JS文件-->
